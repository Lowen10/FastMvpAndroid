...
public class RxFragmentLifecycleHandler extends FragmentManager.FragmentLifecycleCallbacks {


    private RxLifecycleManager mRxLifecycleManager;

    @Inject
    public RxFragmentLifecycleHandler(RxLifecycleManager rxLifecycleManager) {
        this.mRxLifecycleManager = rxLifecycleManager;
    }

    @Override
    public void onFragmentAttached(FragmentManager fm, Fragment f, Context context) {
        if (f instanceof RxLifecycleable) {
    ...
    public void onFragmentDestroyed(FragmentManager fm, Fragment f) {
        if (f instanceof RxLifecycleable) {
            ...
            mRxLifecycleManager.destroyLifecycleSubject(f);
        }
    }
    ...
    private Subject<FragmentEvent> obtainSubject(Fragment fragment) {
        return mRxLifecycleManager.provideLifecycleSubject(fragment);
    }
}
